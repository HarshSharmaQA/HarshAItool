...
// Lazy load the image component to improve initial loading
const BackgroundImage = lazy(() => import('./background-image'));
    ...
    const handleSignUp = async () => {
        ...
        try {
          ...
          if (error.code === 'auth/popup-closed-by-user') {
            setSignInError('Sign-up process was cancelled. Please try again.');
          } else if (error.code === 'auth/account-exists-with-different-credential') {
            setSignInError('An account with this email already exists. Please login instead.');
          } else {
                ...
                <div className="mx-auto grid w-[350px] gap-6">
                    <div className="grid gap-2 text-center">
                     ...
                     <div className="space-y-4">
                        ...
                        <Button onClick={handleSignUp} variant="outline" type="button" className="w-full" disabled={!auth || isSigningIn}>
                             {isSigningIn ? (
                            ...
                            { !auth ? 'Initializing...' : isSigningIn ? 'Signing up...' : 'Sign up with Google' }
                        </Button>
                    </div>
